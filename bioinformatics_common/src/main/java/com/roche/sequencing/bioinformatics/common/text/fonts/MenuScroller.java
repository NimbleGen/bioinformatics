 ...
 * <P>
 * <B>Implementation note:</B> The default number of items to display at a time is 15, and the default scrolling interval is 125 milliseconds.
 * <P>
 *
...
public class MenuScroller {
	...
	/**
	 * Registers a menu to be scrolled, with the specified number of items to display in the scrolling region, the specified scrolling interval, and the specified numbers of items fixed at the top and
	 * bottom of the menu.
	 * 
	 * @param menu
	 *            the menu
	...
	/**
	 * Registers a popup menu to be scrolled, with the specified number of items to display in the scrolling region, the specified scrolling interval, and the specified numbers of items fixed at the
	 * top and bottom of the popup menu.
	 * 
	 * @param menu
	 *            the popup menu
	 * @param scrollCount
	...
	/**
	 * Constructs a <code>MenuScroller</code> that scrolls a popup menu with the default number of items to display at a time, and default scrolling interval.
	 * 
	 * @param menu
	 *            the popup menu
	 */
	...
	/**
	 * Constructs a <code>MenuScroller</code> that scrolls a menu with the specified number of items to display at a time, and default scrolling interval.
	 * 
	 * @param menu
	 *            the menu
	 * @param scrollCount
	...
	/**
	 * Constructs a <code>MenuScroller</code> that scrolls a popup menu with the specified number of items to display at a time, and default scrolling interval.
	 * 
	 * @param menu
	 *            the popup menu
	 * @param scrollCount
	...
	/**
	 * Constructs a <code>MenuScroller</code> that scrolls a menu with the specified number of items to display at a time, and specified scrolling interval.
	 * 
	 * @param menu
	 *            the menu
	 * @param scrollCount
	...
	/**
	 * Constructs a <code>MenuScroller</code> that scrolls a popup menu with the specified number of items to display at a time, and specified scrolling interval.
	 * 
	 * @param menu
	 *            the popup menu
	 * @param scrollCount
	...
	/**
	 * Constructs a <code>MenuScroller</code> that scrolls a menu with the specified number of items to display in the scrolling region, the specified scrolling interval, and the specified numbers of
	 * items fixed at the top and bottom of the menu.
	 * 
	 * @param menu
	 *            the menu
	 * @param scrollCount
	...
	/**
	 * Constructs a <code>MenuScroller</code> that scrolls a popup menu with the specified number of items to display in the scrolling region, the specified scrolling interval, and the specified
	...
	/**
	 * Scrolls the specified item into view each time the menu is opened. Call this method with <code>null</code> to restore the default behavior, which is to show the menu as it last appeared.
	 *
	 * @param item
	...
	/**
	 * Scrolls the item at the specified index into view each time the menu is opened. Call this method with <code>-1</code> to restore the default behavior, which is to show the menu as it last
	 * appeared.
	 *
	 * @param index
