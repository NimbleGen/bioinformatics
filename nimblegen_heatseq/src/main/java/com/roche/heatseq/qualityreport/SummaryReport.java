...
public class SummaryReport {
	...
	public SummaryReport(File summaryReportFile, int uidLength) throws IOException {
		...
		detailsReportWriter.println("processing_time_in_ms" + StringUtil.TAB + "total_input_reads" + StringUtil.TAB + "input_unmapped_reads" + StringUtil.TAB + "input_mapped_reads" + StringUtil.TAB
				...
				+ "uid_ratio" + StringUtil.TAB + "average_uids_per_probe" + StringUtil.TAB + "average_uids_per_probe_with_reads" + StringUtil.TAB + "max_uids_per_probe" + StringUtil.TAB
				+ "average_read_pairs_per_probe_uid" + StringUtil.TAB + "on-target_duplicate_rate" + StringUtil.TAB + "probe-specific_reads" + StringUtil.TAB + "probe_specific_to_total_reads_ratio");
	...
	public void close() {
		...
		detailsReportWriter.println(DateUtil.convertMillisecondsToHHMMSS(processingTimeInMs) + StringUtil.TAB + (mappedReads + unmappedReads) + StringUtil.TAB + unmappedReads + StringUtil.TAB
				...
				+ probeSpecificReads + StringUtil.TAB + formatter.format(probeSpecificToTotalReadsRatio));
